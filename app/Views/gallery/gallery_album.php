                                ...
                                foreach ($galleryImages as $item): ?>
                                    <div data-filter="category_<?= $item->category_id; ?>" class="col-lg-4 col-md-4 col-sm-6 col-xs-12 gallery-item">
                                        <div class="item-inner">
                                            <a class="image-popup lightbox" href="<?= base_url($item->path_big); ?>" data-effect="mfp-zoom-out" title="<?= esc($item->title); ?>">
                                                <img src="<?= base_url($item->path_small); ?>" alt="<?= esc($item->title); ?>" class="img-responsive"/>
                                            </a>
                                        </div>
                                    </div>
                                <?php endforeach;
