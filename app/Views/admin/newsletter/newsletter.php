...
<div class="row">
    ...
    <div class="col-md-6 col-sm-12">
        <div class="box box-primary">
            ...
            <form action="<?= base_url('AdminController/newsletterPost'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="box-body">
                            ...
                            <table class="table table-subscribers">
                                ...
                                <?php foreach ($subscribers as $item): ?>
                                    <tr>
                                        <td><input type="checkbox" name="email[]" value="<?= $item->email; ?>"></td>
                                        <td><?= $item->email; ?></td>
                                        <td><a href="javascript:void(0)" onclick="deleteItem('AdminController/deleteNewsletterPost','<?= $item->id; ?>','<?= trans("confirm_email"); ?>');" class="text-danger"><i class="fa fa-trash"></i>&nbsp;&nbsp;<?= trans('delete'); ?></a></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
