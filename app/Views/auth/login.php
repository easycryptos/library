                ...
                <div class="col-xs-12 col-sm-6 col-md-4 center-box">
                    <div class="content page-contact page-login">
                        ...
                        <form action="<?= base_url('login-post'); ?>" method="post">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="redirectUrl" value="<?= langBaseUrl(); ?>">
                            ...
                            <div class="form-group has-feedback">
                                <input type="text" name="username" class="form-control" placeholder="<?= trans("username_or_email"); ?>" value="<?= esc(old('username')); ?>" required>
                            </div>
                            <div class="form-group has-feedback">
                                <input type="password" name="password" class="form-control" placeholder="<?= trans("password"); ?>" value="<?= esc(old('password')); ?>" required>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12 m-t-10">
                                    <a href="<?= langBaseUrl('forgot-password'); ?>" class="link-forget"><?= trans("forgot_password"); ?>?</a>
                                </div>
                            </div>
                        </form>
                    </div>
